...
namespace Projet_Tech_Pag_Con.Controllers
{
    public class HomeController_1 : Controller
    {
        ...
        public HomeController_1(ILogger<HomeController_1> logger, ApplicationDbContext context)
        {
            _logger = logger;
            _context = context;
        ...
        public async Task<IActionResult> Valider(string Param1000, string Param1111,string Param1, string Param2,string Param3, string Param4, string Param5,string Param6,string Param7,
