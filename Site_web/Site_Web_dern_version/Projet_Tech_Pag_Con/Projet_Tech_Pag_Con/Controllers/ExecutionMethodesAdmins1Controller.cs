...
{
    public class ExecutionMethodesAdmins1Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public ExecutionMethodesAdmins1Controller(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: ExecutionMethodesAdmins1
        public async Task<IActionResult> Index()
        {
            return View(await _context.ExecutionMethodesAdmin.ToListAsync());
        }

        // GET: ExecutionMethodesAdmins1/Details/5
        ...
        // GET: ExecutionMethodesAdmins1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ExecutionMethodesAdmins1/Create
        ...
        // GET: ExecutionMethodesAdmins1/Edit/5
        ...
        // POST: ExecutionMethodesAdmins1/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ExecutionMethodesAdmins1/Delete/5
        ...
        // POST: ExecutionMethodesAdmins1/Delete/5
